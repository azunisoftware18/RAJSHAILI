...
const UPLOAD_URL = `${import.meta.env.VITE_API_URL}/home/upload`; // Assuming separate upload endpoint
const IMAGE_BASE_URL = `${import.meta.env.VITE_API_URL}/`; // Base URL for displaying images
